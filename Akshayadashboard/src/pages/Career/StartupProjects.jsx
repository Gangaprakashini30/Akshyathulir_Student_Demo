    ...
    <Box sx={{ p: { xs: 2, md: 4 }, backgroundColor: '#f4f7f5', minHeight: '100vh' }}>
      ...
      <Stack direction="row" spacing={2} sx={{ mb: 5, alignItems: 'center', flexWrap: 'wrap' }}>
        <TextField
          ...
          sx={{ width: { xs: '100%', md: 350 }, '& .MuiOutlinedInput-root': { borderRadius: 10, bgcolor: '#fff' } }}
          InputProps={{
        ...
        <TextField
          ...
          sx={{ width: { xs: '100%', md: 180 }, '& .MuiOutlinedInput-root': { borderRadius: 10, bgcolor: '#fff' } }}
        >
        ...
        <Button 
          variant="contained" 
          sx={{ borderRadius: 10, bgcolor: '#1a3e2f', px: 4, height: '40px', fontWeight: 'bold' }}
        >
          Search
        </Button>
      </Stack>
          ...
          <Grid item xs={12} sm={6} lg={4} key={project.id}>
            <Card 
              sx={{ 
                ...
                '&:hover': { transform: 'translateY(-8px)', boxShadow: '0px 15px 35px rgba(26, 62, 47, 0.12)', borderColor: '#1a3e2f' } 
              }}
            >
              <CardContent sx={{ p: 3 }}>
                <Stack direction="row" justifyContent="space-between" sx={{ mb: 2 }}>
                  <Avatar sx={{ bgcolor: '#1a3e2f', color: '#fff', width: 40, height: 40 }}>
                ...
                <Typography variant="h6" sx={{ fontWeight: 800, color: '#1a3e2f', mb: 0.5 }}>
                  {project.title}
                </Typography>
                ...
                {/* 3. CORRECTED BUTTON WITH BACKTICKS AND NAVIGATE */}
                <Button 
                  fullWidth 
                  variant="outlined" 
