    ...
    <Box sx={{ p: { xs: 2, md: 5 }, backgroundColor: '#f4f7f5', minHeight: '100vh' }}>
      ...
      <Grid container spacing={4}>
        <Grid item xs={12} md={8}>
          <Card sx={{ p: 4, borderRadius: 4, boxShadow: '0px 4px 20px rgba(0,0,0,0.05)' }}>
        ...
        <Grid item xs={12} md={4}>
          <Card sx={{ p: 3, borderRadius: 4, position: 'sticky', top: 24, border: '1px solid #e0e6e2', boxShadow: '0px 10px 30px rgba(0,0,0,0.04)' }}>
            ...
            <Button fullWidth variant="contained" sx={{ mt: 4, bgcolor: '#1a3e2f', py: 1.5, borderRadius: 3, fontWeight: 'bold' }}>Quick Apply</Button>
          </Card>
        </Grid>
      </Grid>
    </Box>
